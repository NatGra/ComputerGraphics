...
public class Texture {
	private int id; 
	//gespeicherte ID, normalerweise wird hochgezählt
	...
	public Texture(String resourceName, int numberOfMipMapLevels, boolean autoGenerateMipMaps) {
		try {
			createTextureFromImage(ImageIO.read(createInputStreamFromResourceName(resourceName)), 0); //Java-Standard, um Bilder zu laden
